...
The STM32AsyncTCP library should build for Arduino ESP8266 Core releases:
...
modules as well as some client code was: the freeing of STM32AsyncTCP
...
delay() or yield() or any STM32AsyncTCP library family call. For example,
